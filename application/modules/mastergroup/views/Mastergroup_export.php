...
<div class='wrap-cap'>
<div class='cap' style='text-align: center; font-weight: bold;'>Report Data Group<br/ >Effective Date :Date :  <?php echo date_format(date_create(date('Y-m-d')),"d F Y"); ?>
</div>
</div>
</div>
        ...
        <table border='1' class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
         <thead>
                  ...
                  <tbody>
                    ...
                    <?php    
                    if($grpdata){           
                    foreach($grpdata as $value){ 
                    ?>
                    
                    <tr>
                      <td><?php echo $value->CodeGroupID;?></td>
                    ...
                    <tr>
                      <td colspan="8">No Record Data</td>
                    </tr>
