...
<div class='wrap-cap'>
<div class='cap' style='text-align: center; font-weight: bold;'>Report Sele<br/ >Effective Date : <?php echo date_format(date_create(date('Y-m-d')),"d F Y"); ?>
</div>
</div>
</div>
        ...
        <table border='1' class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
         <thead>
                  ...
                  <tbody>
                    ...
                    <?php   
                    if($sldata){            
                    foreach($sldata as $value){ 
                    ?>
                    
                    <tr>
                      <td><?php echo $value->SaleID;?></td>
                      <td><?php echo $value->SaleDate;?></td>
                      <td style='text-align:right;'><?php echo $value->TotalSale;?></td>
